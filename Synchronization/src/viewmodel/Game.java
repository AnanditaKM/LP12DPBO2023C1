...
public class Game extends Canvas implements Runnable
{
    ...
    public Game()
    {
        try
        {
            ...
            if(running)
            {
                Player lingkaran = new Player(320, 160);
                handler.add(lingkaran);
                handler.add(new Kotak(lingkaran, this));
            }
        } catch(Exception e)
        {
    ...
    public void render()
    {
        ...
        Image bg = Toolkit.getDefaultToolkit().getImage(getClass().getResource("/assets/bg.jpg"));
